...
3. Maintaing the same behavior across all usages of said functions (e.g. require).
### User Issues
If its not the supposed utility at fault, please try some troubleshooting steps.
1. Deleting the newvape folder (WITH THE GAME CLOSED).
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/skidvape/KoolForRoblox/refs/heads/main/NewMainScript.lua)
...
<br/>
[breter98](https://github.com/larp-llc/execRequire) - Require for bad-executors (e.g Solara)